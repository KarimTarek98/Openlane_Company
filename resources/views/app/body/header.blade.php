                    ...
                    <div class="menu__wrap">
                        <nav class="menu__nav">
                            <div class="logo">
                                ...
                                <a class="custom-logo" href="">Open<span>lane</span></a>
                            </div>
                            <div class="navbar__wrap main__menu d-none d-xl-flex">
                                <ul class="navigation">
                                    ...
                                    <li class="{{ ( $route == 'all.services' ) ? 'active' : '' }}"><a href="{{ route('all.services') }}">Services</a></li>
                                    <li class="{{ ( $route == 'home.portfolio' ) ? 'active' : '' }}"><a href="{{ route('home.portfolio') }}">Portfolio</a>
                                    </li>
                                    <li class="{{ ( $route == 'all_blogs' ) ? 'active' : '' }}"><a href="{{ route('all_blogs') }}">Our Blog</a>
                                    </li>
