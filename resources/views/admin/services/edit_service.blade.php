                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('update.service') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="service_title" type="text" value="{{ $service->service_title }}" id="service_title">
                                        @error('service_title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="service_description">{{ $service->service_description }}</textarea>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea required="" name="service_list" class="form-control" id="service_list" rows="2" data-role="tagsinput" placeholder="Enter list separated by comma">{{ $service->service_list }}</textarea>
                                        @error('service_list')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <input type="submit" class="btn btn-outline-info waves-effect waves-light" value="Update Service" />
                            </form>
