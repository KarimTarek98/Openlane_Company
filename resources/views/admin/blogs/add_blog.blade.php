                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('store.blog') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input class="form-control" name="blog_title" type="text" value="{{ old('blog_title') }}" id="example-text-input">
                                        @error('blog_title')
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="blog_description" value="{{ old('blog_description') }}"></textarea>
                                ...
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Blog Title</label>
                                    <div class="col-sm-10">
                                        <input class="form-control" name="blog_tags" type="text" value="security,programming" data-role="tagsinput">
                                        @error('blog_title')
                                        <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <input type="submit" class="btn btn-outline-info waves-effect waves-light" value="Add Blog" />
                            </form>
